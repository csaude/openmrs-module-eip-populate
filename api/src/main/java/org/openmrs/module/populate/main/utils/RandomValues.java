...
public class RandomValues {
	...
	int[] encounter_types;
	int[] visit_types;
	int[] patient_identify_types;
	int[] programs;
	int[] providers;
	
	int[] booleanConceptAswers = {7263, 7264};
	
	static Random random = new Random();
	
	public RandomValues(Configurations config) {
		encounter_types = config.getEncounterTypes();
		visit_types = config.getVisitTypes();
		patient_identify_types = config.getPatientIdentifyTypes();
	...
	public int randomBooleanConceptAswer() {
		int luckyPos = random.nextInt(1);
	...
	public Object randomFamilyName() {
	...
	public String randomPatientIdentify() {
		String identify = "";
